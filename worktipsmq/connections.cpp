...
void WorktipsMQ::setup_outgoing_socket(zmq::socket_t& socket, std::string_view remote_pubkey) {
...
ConnectionID WorktipsMQ::connect_sn(std::string_view pubkey, std::chrono::milliseconds keep_alive, std::string_view hint) {
...
ConnectionID WorktipsMQ::connect_remote(std::string_view remote, ConnectSuccess on_connect, ConnectFailure on_failure,
...
WorktipsMQ::proxy_connect_sn(std::string_view remote, std::string_view connect_hint, bool optional, bool incoming_only, bool outgoing_only, std::chrono::milliseconds keep_alive) {
...
void WorktipsMQ::proxy_close_connection(size_t index, std::chrono::milliseconds linger) {
