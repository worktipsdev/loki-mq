# WorktipsMQ - zeromq-based message passing for Worktips projects

This C++14 library contains an abstraction layer around ZeroMQ to support integration with Worktips
...
and local daemon commands, communication channels between worktipsd and auxiliary services (storage
server, worktipsnet), and also provides a local multithreaded job scheduling within a process.
...
also allows configuration of how public connections should be treated: for example, a worktipsd running
